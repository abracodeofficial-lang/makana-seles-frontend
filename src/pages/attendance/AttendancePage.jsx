  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full bg-gray-800 border border-gray-700 rounded-lg ${selected ? 'pl-14' : 'pl-8'} pr-3 py-2.5 h-[42px] text-sm text-gray-100 outline-none focus:border-blue-500 transition-colors`}
      />
